...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: 'Chat Buddy AI',
    description:
      'Real-time conversational AI powered by GPT-3.5, featuring token streaming, dual-view interface, and persistent PostgreSQL storage.',
    longDescription:
      "Chat Buddy AI is a real-time conversational interface that leverages OpenAI's GPT-3.5 model to provide intelligent, context-aware responses. Built with a focus on user experience, it features a dual-view system that seamlessly transitions between a conversation gallery and an active chat interface. The application implements token-by-token streaming for natural conversation flow, complete conversation persistence with PostgreSQL, and a modern design that adapts to light and dark themes.",
    highlights: [
      "Real-time Token Streaming - Watch AI responses appear naturally as they're generated, creating a smooth conversational experience",
      'Intelligent Conversation Management - Automatic title generation from first messages, full-text search across all conversations, and smart date-based grouping',
      'Dual-View Interface - Seamlessly switch between card gallery view for browsing and focused chat view for active conversations',
      'Message Editing - Edit previous messages and regenerate AI responses for different outcomes',
      'Persistent Storage - All conversations and messages are automatically saved to PostgreSQL with relationship integrity',
      'Dark/Light Theme - System-aware theme detection with smooth transitions and consistent styling',
      'Keyboard Shortcuts - Quick navigation with shortcuts like Cmd+K for command palette and Escape for home',
      'Responsive Design - Fully optimized for desktop, tablet, and mobile devices with adaptive layouts',
      'WebSocket Communication - Real-time bidirectional communication with automatic fallback to polling',
      'Error Recovery - Built-in error boundaries and automatic connection retry logic',
      'Optimized Performance - Efficient database queries with proper indexing and connection pooling',
      'Modern UI/UX - Glass-morphism design with smooth animations and intuitive interactions',
    ],
    challenges:
      'Implemented event-driven architecture with WebSocket fallback to polling for reliable real-time communication. Designed efficient database schema with proper relationships and indexing for fast conversation retrieval. Built custom React hooks for complex state management and implemented token-by-token streaming for natural AI response rendering.',
    images: {
    ...
    techStack: [
      ...
      { name: 'Express', icon: '⚡', color: '#000000', proficiency: 85 },
      { name: 'Socket.io', icon: '🔌', color: '#010101', proficiency: 85 },
      { name: 'PostgreSQL', icon: '🐘', color: '#4169E1', proficiency: 82 },
      { name: 'OpenAI API', icon: '🤖', color: '#412991', proficiency: 88 },
      { name: 'Tailwind CSS', icon: '🎨', color: '#06B6D4', proficiency: 90 },
      { name: 'Framer Motion', icon: '🎭', color: '#FF0055', proficiency: 80 },
      { name: 'Vite', icon: '⚡', color: '#646CFF', proficiency: 85 },
    ],
    metrics: {
      performance: 98,
